...
* \version         1.0.1.2
* \date            3 janvier 2016
* \brief           Ouvre une fenêtre Windows et dessine une boule (en trois couleurs) que l'on peut faire tourner avec les flêches de déplacement clavier au dessus d'un "plancher".
